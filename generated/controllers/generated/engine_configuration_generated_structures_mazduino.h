...
// start of CanVirtualInput
struct CanVirtualInput {
	/**
	 * CAN ID (decimal or 0x hex)
	 * offset 0
	 */
	can_id_t id;
	/**
	 * Which byte to read the value from
	 * offset 10
	 */
	uint8_t byte;
	/**
	 * Which bit within the specified byte to read
	 * offset 11
	 */
	uint8_t bitOffset;
	/**
	 * Revert to default if no frame for this period
	 * offset 12
	 */
	scaled_channel<uint8_t, 10, 1> timeout;
	/**
...
static_assert(sizeof(CanVirtualInput) == 16);

// start of CanAnalogInput
struct CanAnalogInput {
	/**
	 * CAN ID (decimal or 0x hex)
	 * offset 0
	 */
	...
	uint8_t alignmentFill_at_11[1] = {};
	/**
	 * Multiplier for raw CAN value
	 * offset 12
	 */
	uint16_t multiplier;
	/**
	 * Divider for raw CAN value
	 * offset 14
	 */
	uint16_t divider;
	/**
	 * Offset for raw CAN value
	 * offset 16
	 */
	int16_t offset;
	/**
...
static_assert(sizeof(CanAnalogInput) == 28);

// start of CanSensorInput
struct CanSensorInput {
	/**
	 * Sensor to override with CAN data
	 * offset 0
	 */
	can_sensor_override_target_e sensor;
	/**
	 * need 4 byte alignment
	 * units: units
	 * offset 1
	...
	/**
	 * Multiplier applied to raw CAN value
	 * offset 14
	 */
	uint16_t multiplier;
	/**
	 * Divider applied to raw CAN value (must be non-zero)
	 * offset 16
	 */
	uint16_t divider;
	/**
	...
	/**
	 * Value used while waiting for CAN data or after timeout
	 * offset 28
	 */
	float defaultValue;
};
static_assert(sizeof(CanSensorInput) == 32);

// start of CanByteConfig
struct CanByteConfig {
	/**
	 * offset 0
	 */
	can_outputs_type_e type;
	/**
	 * offset 1
	 */
	output_channel_e var;
	/**
	 * offset 2
	 */
	uint16_t fixed;
...
static_assert(sizeof(CanByteConfig) == 12);
...
struct CanOutput {
	 ...
	 * offset 0
	 */
	can_output_enable_mode_e enableMode;
	/**
	 * offset 1
	 */
	can_output_logic_output_e logicOutput;
	/**
	 * CAN ID (decimal or 0x hex)
	 * offset 2
	 */
	 ...
	 * offset 16
	 */
	can_outputs_dlc_e dlc;
	/**
	 * offset 17
	 */
	can_outputs_rate_e rate;
	/**
	 * need 4 byte alignment
	 * units: units
	 * offset 18
	 ...
	 * offset 20
	 */
	CanByteConfig byte[8] = {};
};
static_assert(sizeof(CanOutput) == 116);

// start of TriggeredCanOutput
struct TriggeredCanOutput {
	/**
	 * CAN ID (decimal or 0x hex)
	 * offset 0
	 */
	 ...
	 * offset 18
	 */
	switch_input_pin_e triggeredCanOutputTrigger;
	/**
	 * offset 20
	 */
	pin_input_mode_e triggeredCanOutputTriggerPinMode;
	/**
	 * offset 21
	 */
	triggered_can_edge_e triggeredCanOutputEdge;
	/**
	 * need 4 byte alignment
	 * units: units
	 * offset 22
...
static_assert(sizeof(TriggeredCanOutput) == 120);
...
struct engine_configuration_s {
	 ...
	 * offset 4164
	 */
	CanVirtualInput canVirtualInputs[CAN_VIRTUAL_INPUT_PINS_COUNT] = {};
	/**
	 * offset 4292
	 */
	CanAnalogInput canAnalogInputs[CAN_VIRTUAL_INPUT_PINS_COUNT] = {};
	/**
	 * offset 4516
	 */
	CanSensorInput canSensorInputs[CAN_VIRTUAL_INPUT_PINS_COUNT] = {};
	/**
	 * offset 4772
	 */
	CanOutput canOutputs[8] = {};
	/**
	 * offset 5700
	 */
...
struct persistent_config_s {
	 ...
	 * offset 7173
	 */
	uint8_t alignmentFill_at_7173[3] = {};
	/**
	 * units: x
	 * offset 7176
	 */
	 ...
	 * offset 16926
	 */
	uint8_t alignmentFill_at_16926[2] = {};
	/**
	 ...
	 * offset 26443
	 */
	uint8_t alignmentFill_at_26443[1] = {};
	/**
	 ...
	 * offset 26521
	 */
	uint8_t alignmentFill_at_26521[1] = {};
	/**
	 * offset 26522
	 */
	 ...
	 * offset 26537
	 */
	uint8_t alignmentFill_at_26537[3] = {};
	/**
	 ...
	 * offset 26666
	 */
	uint8_t alignmentFill_at_26666[2] = {};
	/**
	offset 26668 bit 0 */
...
static_assert(sizeof(persistent_config_s) == 27120);
