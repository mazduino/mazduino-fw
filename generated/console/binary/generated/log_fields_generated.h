...
static LOG_FIELD_CONSTNESS_SPECIFIER_STORAGE MLG::Entries::Field fields[] = {
	...
	{engine->outputChannels.totalSparkCut, "Ign: Total spark cut", "ratio", 2},
	{engine->outputChannels.totalFuelCut, "Fuel: Total fuel cut", "ratio", 2},
	...
	{engine->outputChannels, 720, 0, "coilState1", ""},
	{engine->outputChannels, 720, 1, "coilState2", ""},
	{engine->outputChannels, 720, 2, "coilState3", ""},
	{engine->outputChannels, 720, 3, "coilState4", ""},
	{engine->outputChannels, 720, 4, "coilState5", ""},
	{engine->outputChannels, 720, 5, "coilState6", ""},
	{engine->outputChannels, 720, 6, "coilState7", ""},
	{engine->outputChannels, 720, 7, "coilState8", ""},
	{engine->outputChannels, 720, 8, "coilState9", ""},
	{engine->outputChannels, 720, 9, "coilState10", ""},
	{engine->outputChannels, 720, 10, "coilState11", ""},
	{engine->outputChannels, 720, 11, "coilState12", ""},
	{engine->outputChannels, 720, 12, "injectorState1", ""},
	{engine->outputChannels, 720, 13, "injectorState2", ""},
	{engine->outputChannels, 720, 14, "injectorState3", ""},
	{engine->outputChannels, 720, 15, "injectorState4", ""},
	{engine->outputChannels, 720, 16, "injectorState5", ""},
	{engine->outputChannels, 720, 17, "injectorState6", ""},
	{engine->outputChannels, 720, 18, "injectorState7", ""},
	{engine->outputChannels, 720, 19, "injectorState8", ""},
	{engine->outputChannels, 720, 20, "injectorState9", ""},
	{engine->outputChannels, 720, 21, "injectorState10", ""},
	{engine->outputChannels, 720, 22, "injectorState11", ""},
	{engine->outputChannels, 720, 23, "injectorState12", ""},
	{engine->outputChannels, 720, 24, "triggerChannel1", ""},
	{engine->outputChannels, 720, 25, "triggerChannel2", ""},
	{engine->outputChannels, 720, 26, "bank 1 intake cam input", ""},
	{engine->outputChannels, 720, 27, "bank 1 exhaust cam input", ""},
	{engine->outputChannels, 720, 28, "bank 2 intake cam input", ""},
	{engine->outputChannels, 720, 29, "bank 2 exhaust cam input", ""},
	{engine->outputChannels, 720, 30, "AE: Map Prediction Active", ""},
	{engine->outputChannels, 720, 31, "Error: Flex", ""},
	...
	{engine->outputChannels.analogMultiSwitchPosition1, "Analog multi-switch 1 position", "", 0},
	{engine->outputChannels.analogMultiSwitchPosition2, "Analog multi-switch 2 position", "", 0},
	{engine->outputChannels.analogMultiSwitchPosition3, "Analog multi-switch 3 position", "", 0},
	{engine->outputChannels.analogMultiSwitchPosition4, "Analog multi-switch 4 position", "", 0},
	{engine->outputChannels.analogMultiSwitchVoltage1, "Analog multi-switch 1 voltage", "V", 3},
	{engine->outputChannels.analogMultiSwitchVoltage2, "Analog multi-switch 2 voltage", "V", 3},
	{engine->outputChannels.analogMultiSwitchVoltage3, "Analog multi-switch 3 voltage", "V", 3},
	{engine->outputChannels.analogMultiSwitchVoltage4, "Analog multi-switch 4 voltage", "V", 3},
