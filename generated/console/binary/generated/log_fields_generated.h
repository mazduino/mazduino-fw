...
static LOG_FIELD_CONSTNESS_SPECIFIER_STORAGE MLG::Entries::Field fields[] = {
	...
	{engine->outputChannels.cel_error_codes_count, "CEL: active sensor faults", "", 0},
	{engine->outputChannels, 8, 0, "CEL: battery voltage out of range", ""},
	{engine->outputChannels, 8, 1, "CEL: MAP sensor out of range", ""},
	{engine->outputChannels, 8, 2, "CEL: IAT sensor out of range", ""},
	{engine->outputChannels, 8, 3, "CEL: CLT sensor out of range", ""},
	{engine->outputChannels, 8, 4, "CEL: TPS sensor out of range", ""},
	{engine->outputChannels, 8, 5, "CEL: AFR/EGO sensor out of range", ""},
	{engine->outputChannels, 8, 6, "CEL: oil temperature out of range", ""},
	{engine->outputChannels, 8, 7, "CEL: oil pressure out of range", ""},
	{engine->outputChannels, 8, 8, "CEL: fuel pressure out of range", ""},
	{engine->outputChannels, 8, 9, "CEL: MAF sensor out of range", ""},
	{engine->outputChannels, 8, 10, "CEL: sync losses over limit", ""},
	{engine->outputChannels, 8, 11, "CEL: fuel/spark cut active", ""},
	{engine->outputChannels, 8, 12, "CEL: shift light active", ""},
